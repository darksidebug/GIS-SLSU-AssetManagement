    <div class="container sign_up">
        <div class="row">
            ...
            <div class="col-md-6">
                <h5 class="note">Please fill the neccessary fields</h5>
                <span id="error"></span>
                <form method="post" action="#" id="sign_up_form">
                    ...
                    <center>
                        ...
                        <h7 style="font-size: 13px;">
                            Already have an account? <a href="{{ url('/sign_in') }}">Sign-in Now</a>
                        </h7>
                    </center>
                ...
                if(pass == pass_cfm)
                {
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            {
                                window.location.href = '<?= base_url(); ?>page/view/home';
                            }
                            else{
